    ...
    <div className="flex items-start gap-2">
      ...
      >
        <CollapsibleTrigger asChild>
          <div
            className={cn(
              "flex w-full cursor-pointer items-center gap-2 rounded-lg border bg-muted/30 p-3 text-left transition-colors hover:bg-muted/40",
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  onChange={(event) =>
                    setPresentationInput(event.target.value)
                  }
      ...
      {/* Regenerate Button - Xaricdə */}
      <Button
        variant="outline"
        size="sm"
        onClick={handleRegenerate}
        disabled={isGeneratingOutline || !prompt}
        className="mt-1 h-9 shrink-0 gap-1.5 rounded-full px-4 text-xs"
      >
        <RefreshCw
          className={cn("size-3.5", isGeneratingOutline && "animate-spin")}
        />
